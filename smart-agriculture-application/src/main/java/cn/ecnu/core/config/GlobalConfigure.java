...
import cn.ecnu.common.annotation.CommonNoRepeat;
import cn.ecnu.common.annotation.CommonWrapper;
import cn.ecnu.common.enums.CommonDeleteFlagEnum;
import cn.ecnu.common.exception.CommonException;
import cn.ecnu.common.pojo.CommonResult;
import cn.ecnu.common.pojo.CommonWrapperInterface;
import cn.ecnu.core.handler.GlobalExceptionUtil;
 ...
 **/
@Configuration
@MapperScan(basePackages = {"cn.ecnu.**.mapper"})
public class GlobalConfigure implements WebMvcConfigurer {
    ...
    public static class CommonWrapperAop {
         ...
         */
        @Pointcut("@annotation(cn.ecnu.common.annotation.CommonWrapper)")
