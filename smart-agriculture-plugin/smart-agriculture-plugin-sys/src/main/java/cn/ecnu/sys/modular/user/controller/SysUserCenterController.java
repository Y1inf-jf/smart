...
import cn.ecnu.sys.modular.user.result.SysUserMessageDetailResult;
import cn.ecnu.sys.modular.user.result.SysUserMessageResult;
import cn.ecnu.sys.modular.user.result.SysUserPicValidCodeResult;
import cn.ecnu.sys.modular.user.result.SysUserPositionResult;
